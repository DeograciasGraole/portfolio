  ...
  const projects = [
    {
      ...
      description: 'A comprehensive e-commerce solution with seamless checkout and user experience',
      category: 'E-COMMERCE',
      color: 'yellow',
    ...
    },
    {
      ...
      description: 'User-centered mobile application with intuitive navigation and delightful interactions',
    ...
    },
    {
      ...
      description: 'Complete brand redesign including logo, visual system, and brand guidelines',
      category: 'BRANDING',
      color: 'light-blue',
    ...
    },
    {
      id: 4,
      title: 'Design System',
      description: 'Comprehensive design system for scalable product development',
              ...
              <div className="portfolio-card">
                ...
                <div className="portfolio-hero">
                  <div className="portfolio-hero-media">
                    ...
                    />
                    <div className="portfolio-icon-fallback" style={{ display: 'none' }}>
                      <span className="portfolio-icon-emoji">{project.icon}</span>
                    </div>
