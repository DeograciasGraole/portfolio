      ...
      <section className="hero-spotlight">
        <div className="spotlight-grid">
          ...
          <div className="spotlight-middle">
            ...
            >
              <p className="spotlight-tagline">Hey👋, I’m a Product Designer</p>
              <h2 className="spotlight-title">DEVANTA EBISON</h2>
          ...
          <div className="spotlight-bottom">
            <div className="spotlight-contact">
              <p>E info@devantaebison.com</p>
              <p>T +1 408 555 0212</p>
            </div>
